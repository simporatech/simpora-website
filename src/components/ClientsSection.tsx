...
export const ClientsSection: React.FC = () => {
  ...
  return (
    <section id="clientes" className="py-16 sm:py-20 lg:py-24 bg-[#F5F7F8] border-t border-black/5 relative z-10 overflow-hidden scroll-mt-20 lg:scroll-mt-24">
          ...
          {CLIENTS_DATA.map((client, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col justify-between p-6 sm:p-7 rounded-2xl bg-white border border-black/[0.06] hover:border-[#97F2CC] transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-1"
              >
                ...
                <div>
                  ...
                  {/* Client Title */}
                  <h3 className="font-display font-bold text-lg sm:text-xl text-[#121212] mb-2 tracking-tight group-hover:text-zinc-900">
                    {client.name}
                  </h3>
